...
import technology.innovate.haziremployee.rest.entity.LeaveTypeData

class LeaveTypesSpinnerAdapter(
    ctx: Context,
    val result: List<LeaveTypeData?>
) : ArrayAdapter<LeaveTypeData>(ctx, 0, result) {
